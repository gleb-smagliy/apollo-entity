  ...
  function Entity() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Entity.__proto__ || Object.getPrototypeOf(Entity)).call.apply(_ref, [this].concat(args))), _this), _this.changeField = function (field, value) {
      ...
      var data = renderPropArgs.data,
          ...
          defaultEntity = renderPropArgs.defaultEntity;
      ...
      var entity = data[name] || defaultEntity;

      return _react2.default.createElement(
        _entityContext.Provider,
        { value: { changeField: _this.changeField, entity: entity } },
        children
      );
  ...
  _createClass(Entity, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          defaultEntity = _props.defaultEntity,
          name = _props.name,
          loading = _props.loading,
          error = _props.error,
          children = _props.children,
          queryProps = _objectWithoutProperties(_props, ['query', 'variables', 'defaultEntity', 'name', 'loading', 'error', 'children']);
...
Entity.propTypes = {
  ...
  defaultEntity: _propTypes2.default.object,
