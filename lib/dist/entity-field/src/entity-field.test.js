...
test('consumeContext should pass entity\'s field to children when field present', function () {
...
test('consumeContext should pass entity\'s field to children when field does not present', function () {
  var children = jest.fn();
  var defaultValue = 'default_value';
  var entity = {};
  var changeField = 123;
  var instance = wrapper({ children: children, name: 'field', defaultValue: defaultValue }).instance();
